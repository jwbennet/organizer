			...
			for(i=0; i<=w.fldOrder.length; i++) {
				...
				switch (w.fldOrder[i]) {
					...
					case 'h':
						...
						w._makeEl(butBase, {'attr': {'field':w.fldOrder[i], 'amount':1}}).addClass('ui-block-'+tmp).buttonMarkup(butPTheme).addClass('button-center').appendTo(divPlus);
						w._makeEl(butBase, {'attr': {'field':w.fldOrder[i], 'amount':1}}).addClass('ui-block-'+tmp).buttonMarkup(butMTheme).addClass('button-center').appendTo(divMinus);
						cnt++;
						break;
					case 'a':
					...
					case 'i':
						...
						w._makeEl(butBase, {'attr': {'field':w.fldOrder[i], 'amount':o.minuteStep}}).addClass('ui-block-'+tmp).buttonMarkup(butPTheme).addClass('button-center').appendTo(divPlus);
						w._makeEl(butBase, {'attr': {'field':w.fldOrder[i], 'amount':o.minuteStep}}).addClass('ui-block-'+tmp).buttonMarkup(butMTheme).addClass('button-center').appendTo(divMinus);
						cnt++;
						break;
				}
			}
